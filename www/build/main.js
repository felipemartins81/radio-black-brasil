...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__player_service__ = __webpack_require__(265);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        this.http.get('http://radioblackbrasil.com/api/tracks/random/').map(function (res) { return res.json(); }).subscribe(function (data) {
            ...
            var interval = setInterval(function () {
                ...
                if (playerService.trackIsLoaded()) {
                    _this.smWaiting = false;
                    _this.smActualTrack = playerService.getTrackInfo();
...
var PlayerService = (function () {
    ...
    //
    PlayerService.prototype.smCreateSound = function (_url, _firstCall) {
        var _this = this;
